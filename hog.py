...
def swine_align(player_score, opponent_score):
    ...
    if player_score > 0 and opponent_score > 0:
        gcd = gcd_finder(player_score,opponent_score)
        if gcd >= 10:
            flag = True
    return flag
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    flag = False
    d = abs(player_score - opponent_score)
    if player_score < opponent_score and d < 3:
        flag = True
    return flag
    # END PROBLEM 4b
...
def make_averaged(original_function, trials_count=1000):
    ...
    def averaged_dice(*args):
        ...
        while k < trials_count:
            sum1 += original_function(*args)
            k += 1
        return sum1 / trials_count
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return max_scoring_num_rolls()  # Replace this statement
    # END PROBLEM 12
